...
(function (root) {
  ...
  DC.CHARACTERS = [
    {id:'geo',name:'地质实习生',subtitle:'岩层会说话，作业不会。',color:'#72d5b0',hp:110,energy:100,speed:224,regen:14,starter:'hammer',secondary:'waterbook',mods:{geo:0.12},passive:'地质伤害 +12% · 110 生命'},
    {id:'early',name:'早八幸存者',subtitle:'出勤率不高，求生欲很高。',color:'#ffc873',hp:100,energy:100,speed:240,regen:14,starter:'waterbook',secondary:'slipper',mods:{dash:0.18},passive:'移动更快 · 闪避冷却缩短 18%'},
    {id:'cram',name:'期末突击人',subtitle:'一晚一支笔，一个奇迹。',color:'#c5a2ed',hp:90,energy:125,speed:229,regen:17,starter:'pencil',secondary:'thermos',mods:{crit:0.07},passive:'125 专注 · 恢复更快 · 暴击 +7%'}
  ];
  DC.DIFFICULTIES = {
    chill:{name:'轻松旁听',description:'敌人伤害 ×0.70，生命 ×0.85；更适合第一次醒来。',enemyHp:0.85,enemyDamage:0.70,bulletSpeed:0.88,reward:0.85},
    normal:{name:'正常修读',description:'标准数值；注意预警、灵活换武器即可。',enemyHp:1,enemyDamage:1,bulletSpeed:1,reward:1},
    nightmare:{name:'期末噩梦',description:'敌人伤害 ×1.22，生命 ×1.20，弹速 ×1.10。',enemyHp:1.20,enemyDamage:1.22,bulletSpeed:1.10,reward:1.25}
  };
  DC.FLOORS = [
