...
(function(root){
  ...
  class Game{
    ...
    enemyBullet(e,a,speed=185,props={}){
      ...
      this.bullets.push({id:++this.uid,x:e.x+Math.cos(a)*(e.r+7),y:e.y+Math.sin(a)*(e.r+7),a,vx:Math.cos(a)*v,vy:Math.sin(a)*v,r:6,age:0,life:5,maxLife:5,friendly:false,damage:(e.damage||11)*D.FLOORS[this.run.floor].baseDamage*this.difficulty.enemyDamage,color:'#fa897f',...props});
    }
